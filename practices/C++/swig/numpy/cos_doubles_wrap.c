...
/*-----------------------------------------------
              @(target):= _cos_doubles.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cos_doubles

#else
#  define SWIG_init    init_cos_doubles

#endif
#define SWIG_name    "_cos_doubles"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_cos_doubles_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "cos_doubles_func", 2, 2, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  cos_doubles_func(arg1,arg2,arg3,arg4);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "cos_doubles_func", _wrap_cos_doubles_func, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
