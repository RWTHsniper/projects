...
{
MPI_Isend(sm1,mat_size*mat_size, MPI_FLOAT, myrank+1, tag, MPI_COMM_WORLD,&request);
...
{
MPI_Isend(sm1, mat_size*mat_size, MPI_FLOAT, myrank+2, tag, MPI_COMM_WORLD,&request);
