...
if (((-tol <= xi_eta_zeta[0]) && (xi_eta_zeta[0] < 1 + tol)))
{
xi_eta_zeta[1]= ((y3b*z1b-y1b*z3b)*xxbar + (x1b*z3b-x3b*z1b)*yybar + (x3b*y1b-x1b*y3b)*zzbar)*denom;
if (((-tol <= xi_eta_zeta[1]) && (xi_eta_zeta[1] < 1 + tol)))
{
xi_eta_zeta[2]= ((y1b*z2b-y2b*z1b)*xxbar + (x2b*z1b-x1b*z2b)*yybar + (x1b*y2b-x2b*y1b)*zzbar)*denom;
if (((-tol <= xi_eta_zeta[2]) && (xi_eta_zeta[2] <= 1 + tol)))
{
if ((-tol <= 1 - (xi_eta_zeta[0]+ xi_eta_zeta[1]+xi_eta_zeta[2])) && (1- (xi_eta_zeta[0]+xi_eta_zeta[1]+xi_eta_zeta[2]) <= 1 + tol))
{
retValue=1;
}
}
