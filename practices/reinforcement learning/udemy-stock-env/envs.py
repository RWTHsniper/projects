...
class TradingEnv(gym.Env):
  ...
  def __init__(self, train_data, init_invest=20000):
    ...
    obs_space = stock_range + price_range + cash_in_hand_range
    max_obs_space = [elem[1] for elem in obs_space]
#    self.observation_space = spaces.MultiDiscrete(max_obs_space)
